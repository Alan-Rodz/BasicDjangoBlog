...
let virtual-env = "/run/media/detr/HDD/Courses/DjangoBasics/Blog/blogVENV"
let bin = "bin"
let path-sep = ":"
...
alias deactivate = source "/run/media/detr/HDD/Courses/DjangoBasics/Blog/blogVENV/bin/deactivate.nu"
